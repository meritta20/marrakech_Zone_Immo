...
@endforeach
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Date de la mise en service </label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="date" class="form-control" name="date_m_srvc" required>
                                </div>
                            </div>
                            ...
                            <div class="form-inline form-group row mb-4">
                                ...
                                <input type="number" min="0" class="meri-number form-control mb-2 mr-sm-2" style="padding-left:15px !important;" id="inlineFormInputName2" placeholder="1,2,3..." name="nbr_etage">

                                <label class="col-6 col-md-3 col-lg-3" for="inlineFormInputGroupUsername2">Nombre de chambre</label>
                                <div class="input-group mb-2 mr-sm-2">
                                    <input type="number" min="0" class="meri-number form-control" name="nbr_chbr" id="inlineFormInputGroupUsername2" placeholder="1,2,3..." required>
                                </div>
                            </div>
                        ...
                        <div class="form-inline form-group row mb-4">
                                ...
                                <input type="number" min="0" class="meri-number form-control mb-2 mr-sm-2" name="prix_min" id="inlineFormInputName2" required>

                                <label class="col-6 col-md-3 col-lg-3" for="inlineFormInputGroupUsername2">Prix Max ( en $)</label>
                                <div class="input-group mb-2 mr-sm-2">

                                    <input type="number" min="0" class=" meri-number form-control" name="prix_max" id="inlineFormInputGroupUsername2" required>
